 ...
 */
package com.zooplus.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(ZooplusappFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(ZooplusappFulfilmentProcessConstants.PARENT_PROCESS);
