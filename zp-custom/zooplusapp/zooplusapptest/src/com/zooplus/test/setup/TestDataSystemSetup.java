...
import com.zooplus.test.constants.ZooplusappTestConstants;
import com.zooplus.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = ZooplusappTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/zooplusapptest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/zooplusapptest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/zooplusapptest/import/cstickets.impex");
			...
			importImpexFile(context, "/zooplusapptest/import/csquotes.impex");
		}
	}
}
