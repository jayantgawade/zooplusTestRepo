 ...
 */
package com.zooplus.cockpits.setup;
...
import com.zooplus.cockpits.constants.ZooplusappCockpitsConstants;
 ...
 */
@SystemSetup(extension = ZooplusappCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(ZooplusappCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(ZooplusappCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						ZooplusappCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/zooplusappcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
