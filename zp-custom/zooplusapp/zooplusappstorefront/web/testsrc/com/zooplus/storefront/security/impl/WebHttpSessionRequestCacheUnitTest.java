...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/zooplusappstorefront/electronics/en",
						"https://electronics.local:9002/zooplusappstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/zooplusappstorefront/electronics/en",
						"https://electronics.local:9002/zooplusappstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/zooplusappstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/zooplusappstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/zooplusappstorefront/electronics/en",
						"https://electronics.local:9002/zooplusappstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/zooplusappstorefront",
						"https://electronics.local:9002/zooplusappstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/zooplusappstorefront",
						"https://electronics.local:9002/zooplusappstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/zooplusappstorefront/electronics/en",
						"https://electronics.local:9002/zooplusappstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
