...
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultRestclientService.class);
	...
	{
		return DefaultRestclientService.class.getResourceAsStream("/restclient/sap-hybris-platform.png");
	}
