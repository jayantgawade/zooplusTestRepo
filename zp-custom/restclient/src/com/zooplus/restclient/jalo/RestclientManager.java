 ...
 */
package com.zooplus.restclient.jalo;
...
/**
 * This is the extension manager of the Restclient extension.
 */
public class RestclientManager extends GeneratedRestclientManager
{
	...
	{
		return (RestclientManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(RestclientConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public RestclientManager() // NOPMD 
	{
		LOG.debug("constructor of RestclientManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of RestclientManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of RestclientManager called, current tenant: {}", getTenant().getTenantID());
	}
